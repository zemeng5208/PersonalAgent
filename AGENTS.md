...
- 默认中文。开始工作前阅读 `docs/PRD.md`、`docs/ARCHITECTURE.md`、`CONTRIBUTING.md` 和相关进度。
...
- 总负责人负责拆分任务、接口协调、集成与验收；工作包必须指定唯一负责人、拥有的文件或模块、依赖和完成标准。
...
- 共享接口由接口负责人维护；提出变更后通知依赖方，不单方面修改调用契约。

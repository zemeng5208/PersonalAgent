...
| 知识 | `KnowledgePort`、Obsidian/LLM Wiki | PR #93 的 MOD-08A 提供 provisional 只读端口与合成 Fake；MOD-08B 分支增加脱机文件只读适配及合成 Vault 测试。真实 Vault 授权/验收、Runtime 接线、Obsidian 插件和 LLM Wiki 仍 unavailable | MOD-08 `goo122` |

...
| MOD-07 | M2 | todo | 未启动 |
| MOD-08 | M2 | todo | 未启动 |
| MOD-09 | M1.6/M4 | review | `goo122` / PR #89、#90 已合并 provisional 端口、Fake 与 SQLite 重启恢复；PR #91 的 MOD-09D 因确认拒绝仍激活旧 scope 事实收到 `CHANGES_REQUESTED`，分支已改为未生效暂存→provider 确认→原子激活，本地全仓门禁通过，待新 head CI 与非作者复审；生产 capability、真实来源和删除仍 unavailable |
